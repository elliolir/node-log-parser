...
const inputLog = '2044-08-09T02:12:51.253Z - info - {"transactionId":"9abc55b2-807b-4361-9dbe-aa88b1b2e978","details":"Service is started"}';
...
describe('LogSerializer - deserialize', () => {
  it('parses an object into the JSON line', () => {
    ...
    const deserialized = '{"timestamp":2354321571253,"loglevel":"info","transactionId":"9abc55b2-807b-4361-9dbe-aa88b1b2e978","details":"Service is started"}'
